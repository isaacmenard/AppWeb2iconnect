...
<head>
	...
	<title>2iConnect - Espace Membre</title>
...
<body>
	...
	<header id="home">
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('./img/nouvelannee.jpg');">
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							<h1 class="white-text">L'équipe 2iConnect vous souhaites :</h1>
							<h4 class="white-text">Une bonne année !
							</h4>
						</div>
					</div>
					<!-- /home content -->
